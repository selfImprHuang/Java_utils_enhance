         ...
         if(!$.cookiesArr[0]){
             ...
             for(let i = 0; i < $.cookiesArr.length; i++){
                 ...
                 if($.cookiesArr[i]){
                     ...
                     $.totalSuccess = 0
                     let size = 1;
					 maxSize = Math.floor(Math.random() * (6 - 1 + 1) + 10)
					 args_xh.maxLength = Math.floor(Math.random() * (7 - 1 + 1) + 8)
