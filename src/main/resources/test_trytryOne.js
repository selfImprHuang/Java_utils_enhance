       ...
       for (let i = 0; i < $.cookiesArr.length; i++) {
         ...
         if ($.cookiesArr[i]) {
           ...
           for (let i = 0; i < list.length; i++) {
             args_xh.maxSize = Math.floor(Math.random() * (15) + 10)
