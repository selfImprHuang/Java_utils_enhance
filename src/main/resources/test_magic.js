...
!(async () => {
  ...
  message += "<font color=\'#FFA500\'>[通知] </font><font color=\'#006400\' size='3'>京东小魔方</font> \n\n"
  ...
  for (let i = 0; i < cookiesArr.length; i++) {
    ...
    if (shareCodes && shareCodes.length) {
      ...
      for (let j = 0; j < shareCodes.length && $.canHelp; j++) {
        ...
        message += "<font color=\'#FFA500\'>" + `\n账号${$.UserName} 去助力 ${shareCodes[j].use} 的助力码 ${shareCodes[j].code}` + "</font> \n\n"
        if ($.UserName === shareCodes[j].use) {
          message += "<font color=\'#FFA500\'>" + `助力失败：不能助力自己` + "</font> \n\n"
            ...
            for (let key of Object.keys(data.assignmentList)) {
              ...
              if (vo.ext.extraType === "sign1") {
                ...
                if (vo.completionCnt < vo.assignmentTimesLimit) {
                  ...
                  message += "<font color=\'#FFA500\'>" + `助力已满` + "</font> \n\n"
                  console.log(`助力已满`)
                }
                    ...
                    for (let key of Object.keys(vo.ext[vo.ext.extraType])) {
                      ...
                      if (task.status !== 2) {
                        ...
                        if (vo.ext.extraType === "browseShop") {
                          message += "<font color=\'#FFA500\'>" + `完成成功：获得${vo.rewards[0].rewardValue}${vo.rewards[0].rewardName}` + "</font> \n\n"
          ...
          if (safeGet(data)) {
            ...
            if (extraType === "assistTaskDetail") {
              if (data.msg === "已达助力上限" || data.subCode === "108") {
                ...
                message += "<font color=\'#FFA500\'>" + `助力失败：${data.msg}` + "</font> \n\n"
              } else if (data.msg === "任务已完成" || data.subCode === "103") {
                $.delcode = true
                console.log(`助力失败：您的好友助力已满`)
                message += "<font color=\'#FFA500\'>" + `助力失败：您的好友助力已满` + "</font> \n\n"
              } else if (data.msg === "任务完成" || data.subCode === "0") {
                console.log(`助力成功`)
                message += "<font color=\'#FFA500\'>" + `助力成功` + "</font> \n\n"
              }
              ...
              message += "<font color=\'#FFA500\'>" + `签到成功：获得${data.rewardsInfo.successRewards[$.type][0] ? `${data.rewardsInfo.successRewards[$.type][0].quantity}${data.rewardsInfo.successRewards[$.type][0].rewardName}` : `${data.rewardsInfo.successRewards[$.type].quantityDetails[0].quantity}${data.rewardsInfo.successRewards[$.type].quantityDetails[0].rewardName}`}` + "</font> \n\n"
            ...
            if (type) {
              ...
              if (data.result.hasFinalLottery === 0) {
                ...
                if (num >= 9) {
                  ...
                  message += "<font color=\'#EA0000\'>" + `共找到${num}个魔方，可开启礼盒` + "</font> \n\n"
                  await getNewFinalLotteryInfo()
                } else {
                  console.log(`共找到${num}个魔方，不可开启礼盒`)
                  message += "<font color=\'#EA0000	\'>" + `共找到${num}个魔方，不可开启礼盒` + "</font> \n\n"
                }
              } else {
                console.log(`已开启礼盒`)
              }
        ...
        if (err) {
          ...
          if (safeGet(data)) {
            ...
            if (data.result.hasDown === 1) {
              ...
              message += "<font color=\'#0000E3\'>" + data.result.isLottery === 1 ? `找到了一个魔方，获得${data.result.lotteryInfoList[0].quantity || ''}${data.result.lotteryInfoList[0].name}` : `找到了一个魔方` + "</font> \n\n"
              $.complete = true
            }
          }
        }
        ...
        if (err) {
          ...
          if (safeGet(data)) {
            ...
            if (data.result.lotteryStatus === 1) {
              ...
              message += "<font color=\'#8600FF\'>" + `开启礼盒成功：获得${data.result.lotteryInfoList[0].quantity}${data.result.lotteryInfoList[0].name}` + "</font> \n\n"

            } else {
              message += "<font color=\'#8600FF\'>" + `开启礼盒成功：${data.result.toast}` + "</font> \n\n"
