...
!(async () => {
    ...
    message += "<font color=\'#FFA500\'>[通知] </font><font color=\'#006400\' size='3'>东子的世界</font> \n\n"
    ...
    message = "<font color=\'#FFA500\'>[通知] </font><font color=\'#006400\' size='3'>东子的世界(开始助力)</font> \n\n"


    console.log(JSON.stringify(invitelist));
    invitelist = [...invitelist, ...($.shareCode || [])]
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        ...
        for (let j = 0; j < invitelist.length && $.canHelp; j++) {
            ...
            message += "<font color=\'#FFA500\'>" + `${$.UserName}去助力${roleMap[$.oneInvite.user]}` + "</font> \n\n"
    ...
    switch (type) {
        ...
        case 'do_task':
            if (data.score) {
                ...
                message += "<font color=\'#FFA500\'>" + `执行成功,获得积分:${data.score}` + "</font> \n\n"
            } else {
                console.log(`执行成功`);
            }
            break;
        case 'do_assist_task':
            ...
            if (data.score) {
                ...
                message += "<font color=\'#FFA500\'>" + `助力次数已用完` + "</font> \n\n"
                console.log(`助力次数已用完`);
            }
            break;
        default:
