...
async function showMsg() {
    ...
    if(typeof $.JdzzNum !== "undefined"){
        ...
        message += "<font color=\'#778899\' size=2>" + `京东赚赚：${$.JdzzNum}金币(≈${$.JdzzNum / 10000}元)\n` +"</font>\n\n"
    }
    if($.JdMsScore!=0){
    ...
    if($.JdFarmProdName != ""){
        if($.JdtreeEnergy!=0){
            ...
            message += "<font color=\'#778899\' size=2>" +`东东农场：${$.JdFarmProdName}\n` +"</font>\n\n"
        }
    }
    if ($.jxFactoryInfo) {
        ReturnMessage += `京喜工厂：${$.jxFactoryInfo}🏭\n`
        message += "<font color=\'#778899\' size=2>" + `京喜工厂：${$.jxFactoryInfo}🏭\n` +"</font>\n\n"
    }
    if ($.ddFactoryInfo) {
        ReturnMessage += `东东工厂：${$.ddFactoryInfo}🏭\n`
        message += "<font color=\'#778899\' size=2>" + `东东工厂：${$.ddFactoryInfo}🏭\n` +"</font>\n\n"
    }
    ...
    ReturnMessage+=`🧧🧧🧧🧧红包明细🧧🧧🧧🧧`;
    message += "<font color=\'#990000\' size=3>" +`🧧🧧🧧🧧红包明细🧧🧧🧧🧧` +  "</font>\n\n"
    ReturnMessage+=`${$.message}\n\n`;
    message += "<font color=\'#778899\' size=2>" + `${$.message}\n\n` +"</font>\n\n"
                ...
                if (err) {
                    ...
                    if (data) {
                        ...
                        if (data['status'] === 200) {
                            ...
                            eval(enCryptMethodJDString+';$.enCryptMethodJD=test');
                        } else {
