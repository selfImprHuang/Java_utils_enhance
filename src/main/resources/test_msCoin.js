...
!(async () => {
  ...
  message += "<font color=\'#FFA500\'>[通知] </font><font color=\'#006400\' size='3'>动动秒杀币</font> \n\n --- \n\n"
          ...
          if (safeGet(data)) {
            ...
            if (data.code === 2041) {
              ...
              if(info){
                ...
                message = message + "<font color=\'#778899\' size=2> " + `当前秒秒币${$.score}` +"</font>\n\n";
              }
            }
          }
        }
...
function showMsg() {
  return new Promise(resolve => {
    message = message + "<font color=\'#778899\' size=2> " + `本次运行获得秒秒币${$.score-$.cur}枚，共${$.score}枚`  +"</font>\n\n";
